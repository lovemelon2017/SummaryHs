...
public class SwitchDetailsActivity extends AppCompatActivity {
    ...
    public static void startTActivity(Activity activity, View transitionView) {
        Intent intent = new Intent(activity, SwitchDetailsActivity.class);
        // 这里指定了共享的视图元素
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailPlayer.getDetailBtn().setVisibility(View.GONE);
        ...
        detailPlayer.getFullscreenButton().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                detailPlayer.startWindowFullscreen(SwitchDetailsActivity.this, true, true);
            }
        });
