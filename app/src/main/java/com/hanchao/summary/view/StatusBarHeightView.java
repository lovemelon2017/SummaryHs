package com.hanchao.summary.view;
...
public class StatusBarHeightView extends LinearLayout {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.StatusBarHeight);
            type = typedArray.getInt(R.styleable.StatusBarHeight_use_type, 0);
            typedArray.recycle();
        }
        if (type == 1) {
